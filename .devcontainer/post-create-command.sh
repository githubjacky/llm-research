...
# 5. setup terminal utils
wget https://gist.githubusercontent.com/githubjacky/20882d09ed0dd5d659a6b5a1336edbe8/raw/eddb7cf09ee2b5386252357d4e8aec86f0a1a969/setup.sh &&
    chmod +x setup.sh &&
    ./setup.sh &&
    rm -f setup.sh

# 6. install ollama cli
